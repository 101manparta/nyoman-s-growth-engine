  ...
  theme: {
    ...
    extend: {
      ...
      backgroundImage: {
        ...
        'tech-grid': 'linear-gradient(hsl(var(--border) / 0.2) 1px, transparent 1px), linear-gradient(90deg, hsl(var(--border) / 0.2) 1px, transparent 1px)',
      },
      boxShadow: {
        'glow': '0 0 20px hsl(var(--primary) / 0.3)',
        'glow-lg': '0 0 40px hsl(var(--primary) / 0.4)',
        'glow-xl': '0 0 60px hsl(var(--primary) / 0.5)',
        'glass': '0 8px 32px hsl(var(--background) / 0.3)',
      },
    },
  },
